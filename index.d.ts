...
declare module "@infinitesolutionssrl/google-spreadsheet" {
// #region ENUMS
...
// #region GOOGLE SPREADSHEET WORKSHEET
  ...
  export class GoogleSpreadsheetWorksheet implements WorksheetBasicProperties {
    constructor(parentSpreadsheet: GoogleSpreadsheetWorksheet, {
      properties,
      data,
    }: { properties: WorksheetBasicProperties, data?: any })
...
// #region GOOGLE SPREADSHEET
  ...
  export class GoogleSpreadsheet implements SpreadsheetBasicProperties {
    ...
    /**
     * @description
     * Use Google's default client to authenticate. Use this when runngin in google cloud
     */
    useDefaultAuthClient(): Promise<void>;
